...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='test_accuracy',choices=['train_mask','test_accuracy','test_embedding'])
    ...
    parser.add_argument('--mode', type=str, default='test_accuracy', choices=['train_mask','test_accuracy','test_embedding'])

    # Directories.
    #parser.add_argument('--image_dir', type=str, default='Datasets/COCOMask/train/train_class/train/')
    parser.add_argument('--image_dir', type=str, default='Datasets/Recover/result/') 
